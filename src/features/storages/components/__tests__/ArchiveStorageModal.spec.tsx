...
import { ArchiveStorageModal } from '../ArchiveStorageModal';
...
describe('Given ArchiveStorageModal confirms the archiving of a storage', () => {
  ...
  describe('When the modal is open and canArchive is true', () => {
    ...
    it('Then the description with storage name is shown', () => {
      render(
        <ArchiveStorageModal
          open={true}
          storage={storage}
  ...
  describe('When canArchive is false (last active storage of its type)', () => {
