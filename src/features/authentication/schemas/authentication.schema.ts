...
/**
 * Contrato: POST /authentication/sign-in request
 */
...
/**
 * Contrato: POST /authentication/sign-up request
 */
...
/**
 * Contrato: POST /authentication/verify-email request
 */
...
/**
 * Contrato: POST /authentication/resend-verification-code request
 */
...
/**
 * Contrato: POST /authentication/refresh request
 * No body — el refresh_token viaja via httpOnly cookie automáticamente
 */
export const RefreshSessionRequestSchema = z.object({});

/**
 * Contrato: POST /authentication/sign-out request
 * No body — el refresh_token viaja via httpOnly cookie automáticamente
 */
...
/**
 * Contrato: POST /authentication/sign-up response
...
/**
 * Contrato: POST /authentication/sign-in response
...
/**
 * Contrato: POST /authentication/refresh response
...
/**
 * Contrato: GET /authentication/me response
 */
...
/**
 * Contrato: POST /authentication/verify-email response
 */
...
/**
 * Contrato: POST /authentication/resend-verification-code response
 */
...
/**
 * Contrato: POST /authentication/forgot-password response
 */
...
/**
 * Contrato: POST /authentication/reset-password response
 */
