    ...
    return (
      <div className="relative">
        ...
        <Input
          ...
          className={cn('h-10 sm:h-12 rounded-lg pl-10 pr-10 bg-authentication-surface dark:bg-authentication-input-bg border-border dark:border-authentication-input-border', className)}
          ref={ref}
          {...props}
        />
        <Button
